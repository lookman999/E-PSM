      ...
      <table style="width:100%">
        <tr>
          <td width="30%" class="topleft">
            ...
            <form action = "/editlogbook/<?php echo $users[0]->id; ?>" method = "post" class="form-group" style="width:70%; margin-left:15%;">
              <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  ...
                  <input type="text" id="Prepared_by" name="Prepared_by" value='<?php echo $users[0]->Prepared_by; ?>'style="width:500px;">
                  <br><br>
